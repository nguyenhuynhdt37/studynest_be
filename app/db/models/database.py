...
class Categories(Base):
    ...
    is_onboarding_visible: Mapped[Optional[bool]] = mapped_column(
        Boolean, server_default=text("true")
    )

    parent: Mapped[Optional["Categories"]] = relationship(
        "Categories", remote_side=[id], back_populates="parent_reverse"
    )
    parent_reverse: Mapped[list["Categories"]] = relationship(
        "Categories", remote_side=[parent_id], back_populates="parent"
    )
    topics: Mapped[list["Topics"]] = relationship("Topics", back_populates="category")
    courses: Mapped[list["Courses"]] = relationship(
        "Courses", back_populates="category"
    )
    discount_targets: Mapped[list["DiscountTargets"]] = relationship(
        "DiscountTargets", back_populates="category"
    )
...
class LearningFields(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(
            ["parent_id"],
            ["public.learning_fields.id"],
            name="learning_fields_learning_fields_fk",
        ),
    ...
    parent: Mapped[Optional["LearningFields"]] = relationship(
        "LearningFields", remote_side=[id], back_populates="parent_reverse"
    )
    parent_reverse: Mapped[list["LearningFields"]] = relationship(
        "LearningFields", remote_side=[parent_id], back_populates="parent"
    )
...
class PlatformWallets(Base):
    ...
    total_in: Mapped[decimal.Decimal] = mapped_column(
        Numeric(12, 2), nullable=False, server_default=text("0")
    )
    total_out: Mapped[decimal.Decimal] = mapped_column(
        Numeric(12, 2), nullable=False, server_default=text("0")
    )
    holding_amount: Mapped[decimal.Decimal] = mapped_column(
        Numeric(14, 2), nullable=False, server_default=text("0")
    )
    platform_fee_total: Mapped[decimal.Decimal] = mapped_column(
        Numeric(14, 2), nullable=False, server_default=text("0")
    )
    currency: Mapped[Optional[str]] = mapped_column(
        Text, server_default=text("'VND'::text")
    )
    ...
    platform_wallet_history: Mapped[list["PlatformWalletHistory"]] = relationship(
        "PlatformWalletHistory", back_populates="wallet"
    )
...
class SupportedLanguages(Base):
    ...
    lesson_codes: Mapped[list["LessonCodes"]] = relationship(
        "LessonCodes", back_populates="language"
    )
...
class User(Base):
    ...
    is_verified_email: Mapped[Optional[bool]] = mapped_column(
    ...
    preferences_embedding_date_updated_at: Mapped[Optional[datetime.datetime]] = (
        mapped_column(DateTime)
    )
    is_banned: Mapped[Optional[bool]] = mapped_column(
        Boolean, server_default=text("false")
    )
    ...
    course_count: Mapped[Optional[int]] = mapped_column(
    ...
    evaluated_count: Mapped[Optional[int]] = mapped_column(
        BigInteger, server_default=text("0")
    )
    ...
    discounts: Mapped[list["Discounts"]] = relationship(
        "Discounts", back_populates="user"
    )
    email_verifications: Mapped[list["EmailVerifications"]] = relationship(
        "EmailVerifications", back_populates="user"
    )
    lecturer_upgrade_payments: Mapped[list["LecturerUpgradePayments"]] = relationship(
        "LecturerUpgradePayments",
        foreign_keys="[LecturerUpgradePayments.user_id]",
        back_populates="user",
    )
    lecturer_upgrade_payments_: Mapped[list["LecturerUpgradePayments"]] = relationship(
        "LecturerUpgradePayments",
        foreign_keys="[LecturerUpgradePayments.verified_by]",
    ...
    platform_settings: Mapped[list["PlatformSettings"]] = relationship(
        "PlatformSettings", back_populates="user"
    )
    user_roles: Mapped[list["UserRoles"]] = relationship(
        "UserRoles", back_populates="user"
    )
    wallets: Mapped["Wallets"] = relationship(
        "Wallets", uselist=False, back_populates="user"
    )
    courses: Mapped[list["Courses"]] = relationship(
        "Courses", foreign_keys="[Courses.approved_by]", back_populates="user"
    )
    courses_: Mapped[list["Courses"]] = relationship(
        "Courses", foreign_keys="[Courses.instructor_id]", back_populates="instructor"
    )
    course_enrollments: Mapped[list["CourseEnrollments"]] = relationship(
        "CourseEnrollments", back_populates="user"
    )
    course_favourites: Mapped[list["CourseFavourites"]] = relationship(
        "CourseFavourites", back_populates="user"
    )
    course_reviews: Mapped[list["CourseReviews"]] = relationship(
        "CourseReviews", back_populates="user"
    )
    course_views: Mapped[list["CourseViews"]] = relationship(
        "CourseViews", back_populates="user"
    )
    transactions: Mapped[list["Transactions"]] = relationship(
        "Transactions", back_populates="user"
    )
    user_embedding_history: Mapped[list["UserEmbeddingHistory"]] = relationship(
        "UserEmbeddingHistory", back_populates="user"
    )
    instructor_earnings: Mapped[list["InstructorEarnings"]] = relationship(
        "InstructorEarnings", back_populates="instructor"
    )
    purchase_items: Mapped[list["PurchaseItems"]] = relationship(
        "PurchaseItems", back_populates="user"
    )
    withdrawal_requests: Mapped[list["WithdrawalRequests"]] = relationship(
        "WithdrawalRequests", back_populates="lecturer"
    )
    discount_history: Mapped[list["DiscountHistory"]] = relationship(
        "DiscountHistory", back_populates="user"
    )
    lesson_active: Mapped[list["LessonActive"]] = relationship(
        "LessonActive", back_populates="user"
    )
    lesson_comments: Mapped[list["LessonComments"]] = relationship(
        "LessonComments", back_populates="user"
    )
    lesson_notes: Mapped[list["LessonNotes"]] = relationship(
        "LessonNotes", back_populates="user"
    )
    lesson_progress: Mapped[list["LessonProgress"]] = relationship(
        "LessonProgress", back_populates="user"
    )
    refund_requests: Mapped[list["RefundRequests"]] = relationship(
        "RefundRequests",
        foreign_keys="[RefundRequests.instructor_id]",
        back_populates="instructor",
    )
    refund_requests_: Mapped[list["RefundRequests"]] = relationship(
        "RefundRequests",
        foreign_keys="[RefundRequests.resolved_by]",
        back_populates="user",
    )
    refund_requests1: Mapped[list["RefundRequests"]] = relationship(
        "RefundRequests",
        foreign_keys="[RefundRequests.user_id]",
        back_populates="user_",
    )
    lesson_comment_reactions: Mapped[list["LessonCommentReactions"]] = relationship(
        "LessonCommentReactions", back_populates="user"
    )
...
class Discounts(Base):
    ...
    __table_args__ = (
        CheckConstraint(
            "applies_to = ANY (ARRAY['global'::text, 'course'::text, 'category'::text, 'specific'::text])",
            name="discounts_applies_to_check",
        ),
        CheckConstraint(
            "created_role = ANY (ARRAY['ADMIN'::text, 'LECTURER'::text])",
            name="discounts_created_role_check",
        ),
        CheckConstraint(
            "discount_type = ANY (ARRAY['percent'::text, 'fixed'::text])",
            name="discounts_discount_type_check",
        ),
        ForeignKeyConstraint(
            ["created_by"], ["public.user.id"], name="discounts_created_by_fkey"
        ),
    ...
    is_hidden: Mapped[Optional[bool]] = mapped_column(
        Boolean, server_default=text("false")
    )
    ...
    discount_targets: Mapped[list["DiscountTargets"]] = relationship(
        "DiscountTargets", back_populates="discount"
    )
    purchase_items: Mapped[list["PurchaseItems"]] = relationship(
        "PurchaseItems", back_populates="discount"
    )
    discount_history: Mapped[list["DiscountHistory"]] = relationship(
        "DiscountHistory", back_populates="discount"
    )
...
class EmailVerifications(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(
            ["user_id"], ["public.user.id"], name="email_verifications_user_fk"
        ),
...
class LecturerUpgradePayments(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(
            ...
            ["public.user.id"],
            ondelete="CASCADE",
            name="lecturer_upgrade_payments_user_id_fkey",
        ),
        ForeignKeyConstraint(
            ["verified_by"],
            ["public.user.id"],
            name="lecturer_upgrade_payments_verified_by_fkey",
        ),
    ...
    user: Mapped["User"] = relationship(
        "User", foreign_keys=[user_id], back_populates="lecturer_upgrade_payments"
    )
    user_: Mapped[Optional["User"]] = relationship(
        "User", foreign_keys=[verified_by], back_populates="lecturer_upgrade_payments_"
    )
...
class Notifications(Base):
    ...
    is_clicked: Mapped[Optional[bool]] = mapped_column(
        Boolean, server_default=text("false")
    )
    ...
    role_target: Mapped[Optional[list[str]]] = mapped_column(
...
class PlatformSettings(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(
            ["updated_by"], ["public.user.id"], name="platform_settings_updated_by_fkey"
        ),
    ...
    platform_fee: Mapped[decimal.Decimal] = mapped_column(
        Numeric(5, 4), nullable=False, server_default=text("0.3000")
    )
    hold_days: Mapped[int] = mapped_column(
        Integer, nullable=False, server_default=text("7")
    )
    payout_min_balance: Mapped[decimal.Decimal] = mapped_column(
        Numeric(12, 2), nullable=False, server_default=text("100000")
    )
    payout_schedule: Mapped[str] = mapped_column(
        String(50),
        nullable=False,
        server_default=text("'mon-wed-fri'::character varying"),
    )
    currency: Mapped[str] = mapped_column(
        String(10), nullable=False, server_default=text("'VND'::character varying")
    )
    allow_wallet_topup: Mapped[bool] = mapped_column(
        Boolean, nullable=False, server_default=text("true")
    )
    allow_auto_withdraw: Mapped[bool] = mapped_column(
        Boolean, nullable=False, server_default=text("false")
    )
    max_discounts_per_course: Mapped[int] = mapped_column(
        Integer, nullable=False, server_default=text("2")
    )
    discount_max_percent: Mapped[int] = mapped_column(
        Integer, nullable=False, server_default=text("90")
    )
    discount_min_price: Mapped[decimal.Decimal] = mapped_column(
        Numeric(12, 2), nullable=False, server_default=text("1000")
    )
    course_min_price: Mapped[decimal.Decimal] = mapped_column(
        Numeric(12, 2), nullable=False, server_default=text("10000")
    )
    course_max_price: Mapped[decimal.Decimal] = mapped_column(
        Numeric(12, 2), nullable=False, server_default=text("20000000")
    )
    course_default_language: Mapped[str] = mapped_column(
        String(20), nullable=False, server_default=text("'vi'::character varying")
    )
    embedding_dim: Mapped[int] = mapped_column(
        Integer, nullable=False, server_default=text("3072")
    )
    search_top_k: Mapped[int] = mapped_column(
        Integer, nullable=False, server_default=text("8")
    )
    rag_max_chunks: Mapped[int] = mapped_column(
        Integer, nullable=False, server_default=text("50")
    )
    max_login_attempts: Mapped[int] = mapped_column(
        Integer, nullable=False, server_default=text("5")
    )
    lock_time_minutes: Mapped[int] = mapped_column(
        Integer, nullable=False, server_default=text("15")
    )
    updated_at: Mapped[datetime.datetime] = mapped_column(
        DateTime, nullable=False, server_default=text("now()")
    )
    instructor_fee: Mapped[Optional[decimal.Decimal]] = mapped_column(
        Numeric(5, 4), Computed("((1)::numeric - platform_fee)", persisted=True)
    )
    updated_by: Mapped[Optional[uuid.UUID]] = mapped_column(Uuid)

    user: Mapped[Optional["User"]] = relationship(
        "User", back_populates="platform_settings"
    )
...
class PlatformWalletHistory(Base):
    ...
    __table_args__ = (
        CheckConstraint(
            "type = ANY (ARRAY['in'::text, 'out'::text, 'hold'::text, 'release'::text, 'fee'::text])",
            name="platform_wallet_history_type_check",
        ),
        ForeignKeyConstraint(
            ["wallet_id"],
            ["public.platform_wallets.id"],
            ondelete="CASCADE",
            name="platform_wallet_history_wallet_id_fkey",
        ),
    ...
    wallet: Mapped["PlatformWallets"] = relationship(
        "PlatformWallets", back_populates="platform_wallet_history"
    )
...
class UserRoles(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(
            ["role_id"], ["public.role.id"], name="user_roles_role_fk"
        ),
        ForeignKeyConstraint(
            ["user_id"],
            ["public.user.id"],
...
class Wallets(Base):
    ...
    user_id: Mapped[uuid.UUID] = mapped_column(Uuid, nullable=False)
    balance: Mapped[Optional[decimal.Decimal]] = mapped_column(
        Numeric(12, 2), server_default=text("0"), comment="Số dư hiện tại của ví"
    )
    total_in: Mapped[Optional[decimal.Decimal]] = mapped_column(
        Numeric(12, 2), server_default=text("0"), comment="Tổng tiền nạp vào"
    )
    total_out: Mapped[Optional[decimal.Decimal]] = mapped_column(
        Numeric(12, 2), server_default=text("0"), comment="Tổng tiền rút ra"
    )
    currency: Mapped[Optional[str]] = mapped_column(
        String(10),
        server_default=text("'VND'::character varying"),
        comment="Đơn vị tiền tệ (VND/USD)",
    )
    is_locked: Mapped[Optional[bool]] = mapped_column(
        Boolean, server_default=text("false"), comment="Khóa ví khi nghi ngờ gian lận"
    )
    ...
    kyc_verified: Mapped[Optional[bool]] = mapped_column(
        Boolean, server_default=text("false")
    )
...
class Courses(Base):
    ...
    __table_args__ = (
        CheckConstraint(
            "level = ANY (ARRAY['beginner'::text, 'intermediate'::text, 'advanced'::text, 'all'::text])",
            name="courses_level_check",
        ),
        ForeignKeyConstraint(
            ["approved_by"],
            ["public.user.id"],
            ondelete="SET NULL",
            name="courses_approved_by_fkey",
        ),
        ForeignKeyConstraint(
            ["category_id"], ["public.categories.id"], name="courses_categories_fk"
        ),
        ForeignKeyConstraint(
            ["instructor_id"], ["public.user.id"], name="courses_user_fk"
        ),
        ForeignKeyConstraint(
            ["topic_id"],
            ["public.topics.id"],
            ondelete="SET NULL",
            name="courses_topic_id_fkey",
        ),
    ...
    title: Mapped[str] = mapped_column(Text, nullable=False)
    slug: Mapped[str] = mapped_column(Text, nullable=False)
    is_lock_lesson: Mapped[bool] = mapped_column(
        Boolean, nullable=False, server_default=text("false")
    )
    ...
    level: Mapped[Optional[str]] = mapped_column(
        Text, server_default=text("'all'::text")
    )
    language: Mapped[Optional[str]] = mapped_column(
        Text, server_default=text("'vi'::text")
    )
    thumbnail_url: Mapped[Optional[str]] = mapped_column(Text)
    promo_video_url: Mapped[Optional[str]] = mapped_column(Text)
    total_length_seconds: Mapped[Optional[int]] = mapped_column(
        Integer, server_default=text("0")
    )
    is_published: Mapped[Optional[bool]] = mapped_column(
        Boolean, server_default=text("false")
    )
    rating_avg: Mapped[Optional[decimal.Decimal]] = mapped_column(
        Numeric(3, 2), server_default=text("0.00")
    )
    ...
    base_price: Mapped[Optional[decimal.Decimal]] = mapped_column(
        Numeric(10, 2), server_default=text("0.00")
    )
    currency: Mapped[Optional[str]] = mapped_column(
        String(10), server_default=text("'VND'::character varying")
    )
    ...
    total_enrolls: Mapped[Optional[int]] = mapped_column(
        BigInteger, server_default=text("0")
    )
    ...
    review_round: Mapped[Optional[int]] = mapped_column(
        Integer, server_default=text("1")
    )
    approval_status: Mapped[Optional[str]] = mapped_column(
        String, server_default=text("'pending'::character varying")
    )
    topic_id: Mapped[Optional[uuid.UUID]] = mapped_column(Uuid)

    user: Mapped[Optional["User"]] = relationship(
        "User", foreign_keys=[approved_by], back_populates="courses"
    )
    category: Mapped[Optional["Categories"]] = relationship(
        "Categories", back_populates="courses"
    )
    instructor: Mapped["User"] = relationship(
        "User", foreign_keys=[instructor_id], back_populates="courses_"
    )
    topic: Mapped[Optional["Topics"]] = relationship("Topics", back_populates="courses")
    course_enrollments: Mapped[list["CourseEnrollments"]] = relationship(
        "CourseEnrollments", back_populates="course"
    )
    course_favourites: Mapped[list["CourseFavourites"]] = relationship(
        "CourseFavourites", back_populates="course"
    )
    course_reviews: Mapped[list["CourseReviews"]] = relationship(
        "CourseReviews", back_populates="course"
    )
    course_sections: Mapped[list["CourseSections"]] = relationship(
        "CourseSections", back_populates="course"
    )
    course_views: Mapped[list["CourseViews"]] = relationship(
        "CourseViews", back_populates="course"
    )
    discount_targets: Mapped[list["DiscountTargets"]] = relationship(
        "DiscountTargets", back_populates="course"
    )
    transactions: Mapped[list["Transactions"]] = relationship(
        "Transactions", back_populates="course"
    )
    user_embedding_history: Mapped[list["UserEmbeddingHistory"]] = relationship(
        "UserEmbeddingHistory", back_populates="course"
    )
    lessons: Mapped[list["Lessons"]] = relationship("Lessons", back_populates="course")
    purchase_items: Mapped[list["PurchaseItems"]] = relationship(
        "PurchaseItems", back_populates="course"
    )
    lesson_active: Mapped[list["LessonActive"]] = relationship(
        "LessonActive", back_populates="course"
    )
    lesson_progress: Mapped[list["LessonProgress"]] = relationship(
        "LessonProgress", back_populates="course"
    )
    lesson_quizzes: Mapped[list["LessonQuizzes"]] = relationship(
        "LessonQuizzes", back_populates="course"
    )
...
class CourseEnrollments(Base):
    ...
    __table_args__ = (
        ...
        ForeignKeyConstraint(
            ...
            ["public.user.id"],
            ondelete="CASCADE",
            name="course_enrollments_user_id_fkey",
        ),
    ...
    enrolled_at: Mapped[Optional[datetime.datetime]] = mapped_column(
        DateTime(True), server_default=text("now()")
    )
    progress: Mapped[Optional[decimal.Decimal]] = mapped_column(
    ...
    course: Mapped[Optional["Courses"]] = relationship(
        "Courses", back_populates="course_enrollments"
    )
    user: Mapped[Optional["User"]] = relationship(
        "User", back_populates="course_enrollments"
    )
...
class CourseFavourites(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(
            ...
            ["public.courses.id"],
            ondelete="CASCADE",
            name="course_favourites_course_id_fkey",
        ),
        ForeignKeyConstraint(
            ["user_id"],
            ["public.user.id"],
            ondelete="CASCADE",
            name="course_favourites_user_id_fkey",
        ),
    ...
    course: Mapped["Courses"] = relationship(
        "Courses", back_populates="course_favourites"
    )
...
class CourseReviews(Base):
    ...
    __table_args__ = (
        CheckConstraint(
            "rating >= 1 AND rating <= 5", name="course_reviews_rating_check"
        ),
        ForeignKeyConstraint(
            ["course_id"],
            ["public.courses.id"],
    ...
    course: Mapped[Optional["Courses"]] = relationship(
        "Courses", back_populates="course_reviews"
    )
    user: Mapped[Optional["User"]] = relationship(
        "User", back_populates="course_reviews"
    )
...
class CourseSections(Base):
    ...
    course: Mapped[Optional["Courses"]] = relationship(
        "Courses", back_populates="course_sections"
    )
    lessons: Mapped[list["Lessons"]] = relationship("Lessons", back_populates="section")
    lesson_quizzes: Mapped[list["LessonQuizzes"]] = relationship(
        "LessonQuizzes", back_populates="section"
    )
...
class CourseViews(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(
            ...
            ["public.courses.id"],
            ondelete="CASCADE",
            name="course_views_course_id_fkey",
        ),
        ForeignKeyConstraint(
            ["user_id"],
            ["public.user.id"],
            ondelete="CASCADE",
            name="course_views_user_id_fkey",
        ),
    ...
    course: Mapped[Optional["Courses"]] = relationship(
        "Courses", back_populates="course_views"
    )
...
class DiscountTargets(Base):
    ...
    __table_args__ = (
        CheckConstraint(
            "course_id IS NOT NULL OR category_id IS NOT NULL",
            name="discount_targets_check",
        ),
        ForeignKeyConstraint(
            ["category_id"],
            ["public.categories.id"],
            ondelete="CASCADE",
            name="discount_targets_category_id_fkey",
        ),
        ForeignKeyConstraint(
            ["course_id"],
            ["public.courses.id"],
            ondelete="CASCADE",
            name="discount_targets_course_id_fkey",
        ),
        ForeignKeyConstraint(
            ["discount_id"],
            ["public.discounts.id"],
    ...
    category: Mapped[Optional["Categories"]] = relationship(
        "Categories", back_populates="discount_targets"
    )
    course: Mapped[Optional["Courses"]] = relationship(
        "Courses", back_populates="discount_targets"
    )
    discount: Mapped["Discounts"] = relationship(
        "Discounts", back_populates="discount_targets"
    )
...
class Transactions(Base):
    ...
    __table_args__ = (
        ...
        ForeignKeyConstraint(
            ["course_id"], ["public.courses.id"], name="transactions_courses_fk"
        ),
        ForeignKeyConstraint(
            ["user_id"],
            ["public.user.id"],
    ...
    ref_id: Mapped[Optional[uuid.UUID]] = mapped_column(
        Uuid, comment="Liên kết đến bảng khác (purchases, lecturer_upgrade_payments)"
    )
    currency: Mapped[Optional[str]] = mapped_column(
        String(10), server_default=text("'VND'::character varying")
    )
    direction: Mapped[Optional[str]] = mapped_column(
        String(10),
        server_default=text("'in'::character varying"),
        comment="in = nạp, out = rút",
    )
    method: Mapped[Optional[str]] = mapped_column(String(50))
    gateway: Mapped[Optional[str]] = mapped_column(
        String(20), comment="Cổng thanh toán: PayPal, MoMo..."
    )
    order_id: Mapped[Optional[str]] = mapped_column(
        String(100), comment="Mã đơn hàng từ PayPal/MoMo"
    )
    status: Mapped[Optional[str]] = mapped_column(
        String(20),
    ...
    course: Mapped[Optional["Courses"]] = relationship(
        "Courses", back_populates="transactions"
    )
    user: Mapped["User"] = relationship("User", back_populates="transactions")
    instructor_earnings: Mapped[list["InstructorEarnings"]] = relationship(
        "InstructorEarnings", back_populates="transaction"
    )
    purchase_items: Mapped[list["PurchaseItems"]] = relationship(
        "PurchaseItems", back_populates="transaction"
    )
    withdrawal_requests: Mapped[list["WithdrawalRequests"]] = relationship(
        "WithdrawalRequests", back_populates="transaction"
    )
...
class UserEmbeddingHistory(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(
            ...
            ["public.courses.id"],
            ondelete="CASCADE",
            name="user_embedding_history_course_id_fkey",
        ),
        ForeignKeyConstraint(
            ["user_id"],
            ["public.user.id"],
            ondelete="CASCADE",
            name="user_embedding_history_user_id_fkey",
        ),
    ...
    course: Mapped["Courses"] = relationship(
        "Courses", back_populates="user_embedding_history"
    )
...
class InstructorEarnings(Base):
    ...
    __table_args__ = (
        CheckConstraint(
            "status::text = ANY (ARRAY['holding'::character varying, 'pending'::character varying, 'paid'::character varying, 'refunded'::character varying]::text[])",
            name="instructor_earnings_status_check",
        ),
        ForeignKeyConstraint(
            ["instructor_id"],
            ["public.user.id"],
            ondelete="CASCADE",
            name="instructor_earnings_instructor_id_fkey",
        ),
        ForeignKeyConstraint(
            ["transaction_id"],
            ["public.transactions.id"],
            ondelete="CASCADE",
            name="instructor_earnings_transaction_id_fkey",
        ),
    ...
    instructor_id: Mapped[uuid.UUID] = mapped_column(Uuid, nullable=False)
    amount_instructor: Mapped[decimal.Decimal] = mapped_column(
        Numeric(12, 2), nullable=False
    )
    amount_platform: Mapped[decimal.Decimal] = mapped_column(
        Numeric(12, 2), nullable=False
    )
    status: Mapped[str] = mapped_column(
        String(20), nullable=False, server_default=text("'holding'::character varying")
    )
    ...
    instructor: Mapped["User"] = relationship(
        "User", back_populates="instructor_earnings"
    )
    transaction: Mapped["Transactions"] = relationship(
        "Transactions", back_populates="instructor_earnings"
    )
...
class Lessons(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(
            ["course_id"], ["public.courses.id"], name="lessons_courses_fk"
        ),
        ForeignKeyConstraint(
            ["section_id"],
            ["public.course_sections.id"],
            ondelete="CASCADE",
    ...
    outcomes: Mapped[Optional[list[str]]] = mapped_column(ARRAY(Text()))
    is_preview: Mapped[Optional[bool]] = mapped_column(
        Boolean, server_default=text("false")
    )
    embedding: Mapped[Optional[Any]] = mapped_column(VECTOR(1536))
    ...
    course: Mapped[Optional["Courses"]] = relationship(
        "Courses", back_populates="lessons"
    )
    section: Mapped[Optional["CourseSections"]] = relationship(
        "CourseSections", back_populates="lessons"
    )
    lesson_active: Mapped[list["LessonActive"]] = relationship(
        "LessonActive", back_populates="lesson"
    )
    lesson_chunks: Mapped[list["LessonChunks"]] = relationship(
        "LessonChunks", back_populates="lesson"
    )
    lesson_codes: Mapped[list["LessonCodes"]] = relationship(
        "LessonCodes", back_populates="lesson"
    )
    lesson_comments: Mapped[list["LessonComments"]] = relationship(
        "LessonComments", back_populates="lesson"
    )
    lesson_notes: Mapped[list["LessonNotes"]] = relationship(
        "LessonNotes", back_populates="lesson"
    )
    lesson_progress: Mapped[list["LessonProgress"]] = relationship(
        "LessonProgress", back_populates="lesson"
    )
    lesson_quizzes: Mapped[list["LessonQuizzes"]] = relationship(
        "LessonQuizzes", back_populates="lesson"
    )
    lesson_resources: Mapped[list["LessonResources"]] = relationship(
        "LessonResources", back_populates="lesson"
    )
    resource_chunks: Mapped[list["ResourceChunks"]] = relationship(
        "ResourceChunks", back_populates="lesson"
    )
...
class PurchaseItems(Base):
    ...
    __table_args__ = (
        CheckConstraint(
            "status = ANY (ARRAY['completed'::text, 'refunded'::text, 'cancelled'::text])",
            name="purchase_items_status_check",
        ),
        ForeignKeyConstraint(
            ["course_id"], ["public.courses.id"], name="purchase_items_course_id_fkey"
        ),
        ForeignKeyConstraint(
            ["discount_id"],
            ["public.discounts.id"],
            name="purchase_items_discount_id_fkey",
        ),
        ForeignKeyConstraint(
            ["transaction_id"],
            ["public.transactions.id"],
            ondelete="CASCADE",
            name="purchase_items_transaction_id_fkey",
        ),
        ForeignKeyConstraint(
            ["user_id"], ["public.user.id"], name="purchase_items_user_id_fkey"
        ),
    ...
    user_id: Mapped[uuid.UUID] = mapped_column(Uuid, nullable=False)
    course_id: Mapped[uuid.UUID] = mapped_column(Uuid, nullable=False)
    original_price: Mapped[decimal.Decimal] = mapped_column(
        Numeric(12, 2), nullable=False
    )
    discounted_price: Mapped[decimal.Decimal] = mapped_column(
        Numeric(12, 2), nullable=False
    )
    status: Mapped[str] = mapped_column(
        Text, nullable=False, server_default=text("'completed'::text")
    )
    ...
    discount: Mapped[Optional["Discounts"]] = relationship(
        "Discounts", back_populates="purchase_items"
    )
    transaction: Mapped["Transactions"] = relationship(
        "Transactions", back_populates="purchase_items"
    )
    user: Mapped["User"] = relationship("User", back_populates="purchase_items")
    discount_history: Mapped[list["DiscountHistory"]] = relationship(
        "DiscountHistory", back_populates="purchase_item"
    )
    refund_requests: Mapped[list["RefundRequests"]] = relationship(
        "RefundRequests", back_populates="purchase_item"
    )
...
class WithdrawalRequests(Base):
    ...
    __table_args__ = (
        ...
        CheckConstraint(
            "status::text = ANY (ARRAY['pending'::character varying, 'approved'::character varying, 'rejected'::character varying, 'payout_pending'::character varying, 'paid'::character varying, 'failed'::character varying, 'processing'::character varying]::text[])",
            name="withdrawal_requests_status_check",
        ),
        ForeignKeyConstraint(
            ["lecturer_id"],
            ["public.user.id"],
            name="withdrawal_requests_lecturer_id_fkey",
        ),
        ForeignKeyConstraint(
            ["transaction_id"],
            ["public.transactions.id"],
            name="withdrawal_requests_transactions_fk",
        ),
    ...
    amount: Mapped[decimal.Decimal] = mapped_column(Numeric(12, 2), nullable=False)
    currency: Mapped[str] = mapped_column(
        String(10), nullable=False, server_default=text("'USD'::character varying")
    )
    ...
    lecturer: Mapped["User"] = relationship(
        "User", back_populates="withdrawal_requests"
    )
    transaction: Mapped[Optional["Transactions"]] = relationship(
        "Transactions", back_populates="withdrawal_requests"
    )
...
class DiscountHistory(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(
            ["discount_id"],
            ["public.discounts.id"],
            name="discount_history_discount_id_fkey",
        ),
        ForeignKeyConstraint(
            ["purchase_item_id"],
            ["public.purchase_items.id"],
            ondelete="CASCADE",
            name="discount_history_purchase_items_fk",
        ),
        ForeignKeyConstraint(
            ["user_id"], ["public.user.id"], name="discount_history_user_id_fkey"
        ),
    ...
    discount_id: Mapped[uuid.UUID] = mapped_column(Uuid, nullable=False)
    discounted_amount: Mapped[decimal.Decimal] = mapped_column(
        Numeric(12, 2), nullable=False
    )
    created_at: Mapped[Optional[datetime.datetime]] = mapped_column(
        DateTime, server_default=text("now()")
    ...
    discount: Mapped["Discounts"] = relationship(
        "Discounts", back_populates="discount_history"
    )
    purchase_item: Mapped["PurchaseItems"] = relationship(
        "PurchaseItems", back_populates="discount_history"
    )
...
class LessonActive(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(
            ...
            ["public.courses.id"],
            ondelete="CASCADE",
            name="lesson_active_course_fk",
        ),
        ForeignKeyConstraint(
            ["lesson_id"],
            ["public.lessons.id"],
            ondelete="CASCADE",
            name="lesson_active_lesson_fk",
        ),
        ForeignKeyConstraint(
            ["user_id"],
            ["public.user.id"],
            ondelete="CASCADE",
            name="lesson_active_user_fk",
        ),
...
class LessonChunks(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(
            ...
            ["public.lessons.id"],
            ondelete="CASCADE",
            name="lesson_chunks_lesson_id_fkey",
        ),
    ...
    lesson: Mapped[Optional["Lessons"]] = relationship(
        "Lessons", back_populates="lesson_chunks"
    )
...
class LessonCodes(Base):
    ...
    __table_args__ = (
        CheckConstraint(
            ...
            name="lesson_codes_difficulty_check",
        ),
        ForeignKeyConstraint(
            ["language_id"],
            ["public.supported_languages.id"],
            name="lesson_codes_language_id_fkey",
        ),
        ForeignKeyConstraint(
            ["lesson_id"],
            ["public.lessons.id"],
            ondelete="CASCADE",
            name="lesson_codes_lesson_id_fkey",
        ),
    ...
    memory_limit: Mapped[Optional[int]] = mapped_column(
        BigInteger, server_default=text("256000000")
    )
    is_active: Mapped[Optional[bool]] = mapped_column(
        Boolean, server_default=text("true")
    )
    ...
    language: Mapped[Optional["SupportedLanguages"]] = relationship(
        "SupportedLanguages", back_populates="lesson_codes"
    )
    lesson: Mapped["Lessons"] = relationship("Lessons", back_populates="lesson_codes")
    lesson_code_files: Mapped[list["LessonCodeFiles"]] = relationship(
        "LessonCodeFiles", back_populates="lesson_code"
    )
    lesson_code_testcases: Mapped[list["LessonCodeTestcases"]] = relationship(
        "LessonCodeTestcases", back_populates="lesson_code"
    )
...
class LessonComments(Base):
    ...
    __table_args__ = (
        ...
        CheckConstraint(
            "status::text = ANY (ARRAY['visible'::character varying, 'hidden'::character varying, 'deleted'::character varying]::text[])",
            name="lesson_comments_status_check",
        ),
        ForeignKeyConstraint(
            ["lesson_id"],
            ["public.lessons.id"],
            ondelete="CASCADE",
            name="lesson_comments_lesson_id_fkey",
        ),
        ForeignKeyConstraint(
            ["parent_id"],
            ["public.lesson_comments.id"],
            ondelete="CASCADE",
        ...
        ForeignKeyConstraint(
            ...
            ["public.user.id"],
            ondelete="CASCADE",
            name="lesson_comments_user_id_fkey",
        ),
    ...
    parent_id: Mapped[Optional[uuid.UUID]] = mapped_column(Uuid)
    status: Mapped[Optional[str]] = mapped_column(
        String(20), server_default=text("'visible'::character varying")
    )
    ...
    lesson: Mapped["Lessons"] = relationship(
        "Lessons", back_populates="lesson_comments"
    )
    parent: Mapped[Optional["LessonComments"]] = relationship(
        "LessonComments", remote_side=[id], back_populates="parent_reverse"
    )
    parent_reverse: Mapped[list["LessonComments"]] = relationship(
        "LessonComments", remote_side=[parent_id], back_populates="parent"
    )
    user: Mapped["User"] = relationship("User", back_populates="lesson_comments")
    lesson_comment_reactions: Mapped[list["LessonCommentReactions"]] = relationship(
        "LessonCommentReactions", back_populates="comment"
    )
...
class LessonNotes(Base):
    ...
    __table_args__ = (
        ...
        ForeignKeyConstraint(
            ...
            ["public.lessons.id"],
            ondelete="CASCADE",
            name="lesson_notes_lesson_id_fkey",
        ),
        ForeignKeyConstraint(
            ["user_id"],
            ["public.user.id"],
            ondelete="CASCADE",
            name="lesson_notes_user_id_fkey",
        ),
...
class LessonProgress(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(
            ...
            ["public.courses.id"],
            ondelete="CASCADE",
            name="lesson_progress_course_id_fkey",
        ),
        ForeignKeyConstraint(
            ["lesson_id"],
            ["public.lessons.id"],
    ...
    course: Mapped["Courses"] = relationship(
        "Courses", back_populates="lesson_progress"
    )
    lesson: Mapped["Lessons"] = relationship(
        "Lessons", back_populates="lesson_progress"
    )
...
class LessonQuizzes(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(
            ...
            ["public.courses.id"],
            ondelete="CASCADE",
            name="lesson_quizzes_course_id_fkey",
        ),
        ForeignKeyConstraint(
            ["lesson_id"],
            ["public.lessons.id"],
            ondelete="CASCADE",
            name="lesson_quizzes_lesson_id_fkey",
        ),
        ForeignKeyConstraint(
            ["section_id"],
            ["public.course_sections.id"],
            ondelete="CASCADE",
            name="lesson_quizzes_section_id_fkey",
        ),
    ...
    created_by: Mapped[Optional[str]] = mapped_column(
        String(20), server_default=text("'ai'::character varying")
    )
    embedding: Mapped[Optional[Any]] = mapped_column(VECTOR(1536))
    created_at: Mapped[Optional[datetime.datetime]] = mapped_column(
        DateTime, server_default=text("now()")
    ...
    course: Mapped[Optional["Courses"]] = relationship(
        "Courses", back_populates="lesson_quizzes"
    )
    lesson: Mapped[Optional["Lessons"]] = relationship(
        "Lessons", back_populates="lesson_quizzes"
    )
    section: Mapped[Optional["CourseSections"]] = relationship(
        "CourseSections", back_populates="lesson_quizzes"
    )
    lesson_quiz_options: Mapped[list["LessonQuizOptions"]] = relationship(
        "LessonQuizOptions", back_populates="quiz"
    )
...
class LessonResources(Base):
    ...
    embed_status: Mapped[Optional[str]] = mapped_column(
        Text, server_default=text("'idle'::text")
    )

    lesson: Mapped[Optional["Lessons"]] = relationship(
        "Lessons", back_populates="lesson_resources"
    )
    resource_chunks: Mapped[list["ResourceChunks"]] = relationship(
        "ResourceChunks", back_populates="resource"
    )
...
class LessonVideos(Base):
    ...
    source_type: Mapped[Optional[str]] = mapped_column(
        String, server_default=text("'upload_drive'::character varying")
    )
...
class RefundRequests(Base):
    ...
    __table_args__ = (
        CheckConstraint(
            "status::text = ANY (ARRAY['requested'::character varying, 'instructor_approved'::character varying, 'instructor_rejected'::character varying, 'admin_approved'::character varying, 'admin_rejected'::character varying, 'refunded'::character varying]::text[])",
            name="refund_requests_status_check",
        ),
        ForeignKeyConstraint(
            ["instructor_id"],
            ["public.user.id"],
            name="refund_requests_instructor_id_fkey",
        ),
        ForeignKeyConstraint(
            ["purchase_item_id"],
            ["public.purchase_items.id"],
            ondelete="CASCADE",
            name="refund_requests_purchase_item_id_fkey",
        ),
        ForeignKeyConstraint(
            ["resolved_by"], ["public.user.id"], name="refund_requests_resolved_by_fkey"
        ),
        ForeignKeyConstraint(
            ["user_id"], ["public.user.id"], name="refund_requests_user_id_fkey"
        ),
    ...
    status: Mapped[str] = mapped_column(
        String(30),
        nullable=False,
        server_default=text("'requested'::character varying"),
    )
    ...
    instructor_reviewed_at: Mapped[Optional[datetime.datetime]] = mapped_column(
        DateTime
    )
    ...
    instructor: Mapped["User"] = relationship(
        "User", foreign_keys=[instructor_id], back_populates="refund_requests"
    )
    purchase_item: Mapped["PurchaseItems"] = relationship(
        "PurchaseItems", back_populates="refund_requests"
    )
    user: Mapped[Optional["User"]] = relationship(
        "User", foreign_keys=[resolved_by], back_populates="refund_requests_"
    )
    user_: Mapped["User"] = relationship(
        "User", foreign_keys=[user_id], back_populates="refund_requests1"
    )
...
class LessonCodeFiles(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(
            ["lesson_code_id"],
            ["public.lesson_codes.id"],
            ondelete="CASCADE",
            name="lesson_code_files_lesson_code_id_fkey",
        ),
        ...
        UniqueConstraint(
            ...
            "filename",
            "role",
            name="lesson_code_files_lesson_code_id_user_id_filename_role_key",
        ),
        {"schema": "public"},
    )
    ...
    role: Mapped[str] = mapped_column(
        Enum("solution", "starter", "user", name="code_file_role"),
        nullable=False,
        server_default=text("'solution'::code_file_role"),
    ...
    user_id: Mapped[Optional[uuid.UUID]] = mapped_column(Uuid)
    is_main: Mapped[Optional[bool]] = mapped_column(
        Boolean, server_default=text("false")
    )
    created_at: Mapped[Optional[datetime.datetime]] = mapped_column(
        DateTime(True), server_default=text("now()")
    ...
    lesson_code: Mapped["LessonCodes"] = relationship(
        "LessonCodes", back_populates="lesson_code_files"
    )
...
class LessonCodeTestcases(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(
            ...
            ["public.lesson_codes.id"],
            ondelete="CASCADE",
            name="lesson_code_testcases_lesson_code_id_fkey",
        ),
    ...
    is_sample: Mapped[Optional[bool]] = mapped_column(
        Boolean, server_default=text("false")
    )
    order_index: Mapped[Optional[int]] = mapped_column(
        Integer, server_default=text("0")
    ...
    lesson_code: Mapped["LessonCodes"] = relationship(
        "LessonCodes", back_populates="lesson_code_testcases"
    )
...
class LessonCommentReactions(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(
            ...
            ["public.lesson_comments.id"],
            ondelete="CASCADE",
            name="lesson_comment_reactions_comment_id_fkey",
        ),
        ForeignKeyConstraint(
            ["user_id"],
            ["public.user.id"],
            ondelete="CASCADE",
            name="lesson_comment_reactions_user_id_fkey",
        ),
        PrimaryKeyConstraint("id", name="lesson_comment_reactions_pkey"),
        UniqueConstraint(
            "comment_id",
            "user_id",
            name="lesson_comment_reactions_comment_id_user_id_key",
        ),
    ...
    comment: Mapped["LessonComments"] = relationship(
        "LessonComments", back_populates="lesson_comment_reactions"
    )
    user: Mapped["User"] = relationship(
        "User", back_populates="lesson_comment_reactions"
    )
...
class LessonQuizOptions(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(
            ["quiz_id"],
            ["public.lesson_quizzes.id"],
            ondelete="CASCADE",
            name="lesson_quiz_options_quiz_id_fkey",
        ),
    ...
    quiz: Mapped[Optional["LessonQuizzes"]] = relationship(
        "LessonQuizzes", back_populates="lesson_quiz_options"
    )
...
class ResourceChunks(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(
            ...
            ["public.lessons.id"],
            ondelete="CASCADE",
            name="resource_chunks_lesson_id_fkey",
        ),
        ForeignKeyConstraint(
            ["resource_id"],
            ["public.lesson_resources.id"],
            ondelete="CASCADE",
            name="resource_chunks_resource_id_fkey",
        ),
    ...
    chunk_type: Mapped[Optional[str]] = mapped_column(
        Text, server_default=text("'pdf'::text")
    )
    embedding: Mapped[Optional[Any]] = mapped_column(VECTOR(1536))
    ...
    lesson: Mapped[Optional["Lessons"]] = relationship(
        "Lessons", back_populates="resource_chunks"
    )
    resource: Mapped[Optional["LessonResources"]] = relationship(
        "LessonResources", back_populates="resource_chunks"
    )
